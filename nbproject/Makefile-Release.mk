...
${OBJECTDIR}/TutorialApplication.o: TutorialApplication.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TutorialApplication.o TutorialApplication.cpp

${OBJECTDIR}/BaseApplication.o: BaseApplication.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BaseApplication.o BaseApplication.cpp
